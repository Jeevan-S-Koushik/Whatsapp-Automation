...
def aboutme():
    abo = Label(whatsappautomation, text="HI THSI IS JEEVAN S KOUSHIK.THIS IS THE WHATSAPP AUTOMATION", fg="white", bg="black")
    abo.place(x=10, y=490)
    abo1 = Label(whatsappautomation, text="HERE YOU CAN SEND TEXT PRIVATELY OR IN GROUP", fg="white", bg="black")
    abo1.place(x=10, y=520)
...
about = Button(whatsappautomation, text="ABOUT", width=13, height=2,fg="white",bg="black",command=aboutme)
about.place(x=100, y=440)
